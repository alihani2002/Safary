namespace Domain.Consts
{
    public static class Errors
    {
		...
		public const string RegexPhoneNumber = "Invalid phone number";
		public const string MaxHourDuration = "Please ensure that the duration specified does not exceed the maximum allowed time limit";
		public const string DateValidation = " Please ensure that the date provided is valid and falls within the acceptable range.";
